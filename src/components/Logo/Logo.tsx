...
const Logo = ({ width = 400, color = colors.green }: LogoProps) => {
  ...
  return (
    ...
    c4.3,0.6,6.2,1.7,6.2,6.9v55.8c0,6.4-2.3,9.9-7,10.8L0,81.9V87h0.9c0.1,0,8-0.4,16.2-0.4c5,0,7.8,0.1,10.6,0.2
      ...
      <Svg.Path
        fill={color}
        d="M466.6,73.4l-5.1-58.7c-0.4-5,4.5-6.5,6-6.8l3.9-0.9V2h-0.9c-0.1,0-8.6,0.4-20.1,0.4h-0.9v0.9
      ...
      <Svg.Path
        fill={color}
        d="M500.5,2.4c-9.1,0-16.6-0.4-16.7-0.4h-0.9v5.1l4.7,0.7c4.3,0.6,6.2,1.7,6.2,6.9v55.8c0,6.4-2.3,9.9-7,10.8
      ...
      <Svg.Path
        fill={color}
        d="M592.3,0.1L592,0.5c0,0.1-1,1.5-4,1.5h-54.8c-3.1,0-4-1.4-4-1.4L529,0.1h-4.2l-1.4,19.4l4.5,0.9l0.2-0.8
